...
<template>
  ...
  <ul class="md:flex md:space-x-9 xl:mr-7">
    <li>
      <a href="#" class="text-gray-900 font-black  hover:text-amber-600">Inicio</a>
    </li>
    <li>
      <a href="#Servicios" class="text-gray-900 font-black  hover:text-amber-600 ">Servicios</a>
    </li>
    <li>
      <a href="#Swiper" class="block text-gray-900 font-black  hover:text-amber-600">Proyectos</a>
    </li>
    <li>
      <a href="#footer" class="block text-gray-900 font-black  hover:text-amber-600">Contacto</a>
    </li>
  </ul>
</nav>
