...
function createCard(cardInfo) {
    ...
    title.className = "text-lg lg:max-w-p p-1 mt-2 lg:text-base xl:text-lg text-center text-white group-hover:text-slate-100 font-bold mb-1";
    ...
    description.className = "font-thin lg:text-xs lg:leading-normal text-start p-2 mt-2 text-white group-hover:text-etasa mb-10 m-1 text-sm";
